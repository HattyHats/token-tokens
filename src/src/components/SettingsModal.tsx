...
import { X, Trash2, Database, Shield, RefreshCw } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-[600] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-bg2 border border-border rounded-xl w-full max-w-md shadow-2xl overflow-hidden"
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="pt-4 border-t border-border flex flex-col gap-3">
            <button
              onClick={() => {
                if (window.confirm('Are you sure you want to clear all local data? This will reset your watchlist and drawings.')) {
                  onReset();
                  onClose();
                }
              }}
